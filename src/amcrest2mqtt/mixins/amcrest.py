    ...
    async def build_camera(self: Amcrest2Mqtt, camera: dict) -> str:
        ...
        device = {
            ...
            "cmps": {
                "camera": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "camera"),
                ...
                "motion_snapshot": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "motion_snapshot"),
                ...
                "reboot": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "reboot"),
                ...
                "privacy": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "privacy"),
                ...
                "event_text": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "event_text"),
                ...
                "save_recordings": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "save_recordings"),
                ...
                "storage_used": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "storage_used"),
                ...
                "storage_used_pct": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "storage_used_pct"),
                ...
                "storage_total": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "storage_total"),
        ...
        if camera.get("is_doorbell", None):
            device["cmps"]["doorbell"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "doorbell"),
        ...
        if camera.get("is_ad410", None):
            device["cmps"]["human"] = {
                ...
                "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "human"),
        ...
        if not self.is_discovered(device_id):
            self.logger.info(
                f'added new camera: "{camera["device_name"]}" {camera["vendor"]} {camera["device_type"]} '
                f"('{self.get_device_name(device_id)}') mac={camera['network']['mac']}"
            )
