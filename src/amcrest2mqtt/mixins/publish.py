...
class PublishMixin:
        ...
        device = {
            ...
            "cmps": {
                ...
                "last_call": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service_name, "last_call"),
                ...
                "storage_interval": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service_name, "storage_interval"),
                ...
                "snapshot_interval": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service_name, "snapshot_interval"),
    ...
    async def publish_service_state(self: Amcrest2Mqtt) -> None:
        ...
        service = {
            ...
            "last_call": last_call_date.replace(tzinfo=local_tz).astimezone(UTC).isoformat(),
    ...
    async def publish_device_state(self: Amcrest2Mqtt, device_id: str, subject: str = "", sub: str = "", publish_all: bool = False) -> None:
